  ...
  return (
    <footer>
      <div className="md:flex">
        <div className="w-full md:w-1/2 py-14 lg:ps-32 bg-[#1F2937] text-white text-center">
        ...
        <div className="bg-[#111827] text-white w-full md:w-1/2 text-center py-14 lg:pe-44 space-y-2">
      ...
      <div className="footer footer-center p-4 bg-black text-white text-center">
        <div>
