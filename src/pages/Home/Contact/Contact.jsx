...
const Contact = () => {
  return (
    <div className="px-10 py-10 md:py-14 mx-2 lg:mx-8 dark:bg-slate-800 bg-slate-950 text-white text-center">
      <p>Call Us: <span className="text-slate-300">+88 123456789</span></p>
      <p>Email Us: <span className="text-slate-300">easyshop@gmail.com</span></p>
      <Link to='/contact'>
        <button
